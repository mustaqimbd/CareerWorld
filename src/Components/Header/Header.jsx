...
const Header = () => {
    return (
        <div className='flex gap-5 items-center bg-[#F9F9FF]'>
            <div className='w-[40%]'>
                <h1 className='text-[57px] font-bold leading-[4rem]'>One Step Closer To Your <span className='text-[#9873FF]'>Dream Job</span></h1>
            ...
            <div>
                <img className='h-[600px] w-full' src="/public/All Images/P3OLGJ1 copy 1.png" alt="" />
            </div>
        </div>
    );
};
